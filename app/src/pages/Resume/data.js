export default {
  ...
  breifDesc: `八年web前后端开发经验，熟练掌握React/Vue/Typescript/es6，熟练掌握Html5/Css3响应式web开发，有丰富的微前端实战经验，熟悉公共组件库的建设，擅长组件封装并实现代码重用。善于研究和探索，有较强解决问题的能⼒，对代码质量和产品性能有较⾼的要求。`,
  metaInfo: [
    ...
    {
      title: "个人主页",
      value: "http://xitengfei.github.io",
      icon: "icon-github",
    },
  ],
  workExperience: [
