export default {
  ...
  breifDesc: `八年web前后端开发经验，熟练掌握ReactJs/es6/Typescript，熟练掌握Html5/Css3响应式web开发，有丰富的微前端实战经验，熟悉公共组件库的建设。善于研究和探索，有较强解决问题的能⼒，对代码质量和产品性能有较⾼的要求。`,
  metaInfo: [
...
//             `,
  ...
  projectExperience: [
    ...
    },
    {
      ...
      description: `
        这是⼀个报表分析类的项目，提供数据可视化等丰富的功能，在这个项目中目前负责筛选器等相关功能的开发，筛选器是整个产品的数据交互纽带，在开发相关功能的同时需要和其它模块做好融合，需要更多地从架构的⾓度去设计开发和解决问题。在开发这个产品的过程中，对于复杂的功能需求，不断尝试将相关的代码逻辑进⾏提取，抽取出服务，⾏为，模型等，并运⽤react 的⾼阶组件对⼀些重复的代码进⾏封装。`,
    },
    {
      name: 'Intranet',
