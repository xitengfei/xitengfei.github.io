export default {
  ...
  breifDesc: `六年web前后端开发经验，熟练掌握ReactJs/es6/Typescript，熟练掌握Html5/Css3响应式web开发，有丰富的微前端实战经验，熟悉公共组件库的建设。善于研究和探索，有较强解决问题的能⼒，对代码质量和产品性能有较⾼的要求。`,
  metaInfo: [
  ...
  workExperience: [
    {
      ...
      <h5>负责数据中台项目的研发工作</h5>
      <ol>
        <li>负责产品需求的设计、开发，并解决技术难题</li>
        <li>完成了微前端升级改造</li>
        <li>建立了前端公共组件库，并封装了一系列的公共组件，提高了项目的质量和开发效率</li>
        <li>代码重构，增强产品的稳定性和可维护性</li>
        <li>与产品经理协作优化用户体验</li>
      </ol>`,
    },
    {
...
//             `,
  ...
  projectExperience: [
    {
      ...
      period: '2020.07 — 今',
      description: `
        这是一个由微前端和后端微服务组织起来的数据中台项目，来到这个项目后，我首先对微前端架构进行了调整，将
        登陆校验等逻辑以及页面上的公共部分统一放在基座应用上，子应用可以只关注自身业务逻辑。后来又利用father+dumi
        的技术建立了前端公共组件库(之前项目是使用git子模块来进行组件代码共用，有很多问题)。在改项目中，全面使用
        函数式组件进行开发，同时配合typescript使用，再加上自定义hooks等，开发效率和项目质量得到进一步提高。
        `,
    },
    {
      name: '⽤友云智能分析项目',
    ...
    },
    {
      ...
      前端是React全家桶配合Ant Design和TypeScript , 同时还对接了Google, AWS等第三⽅服务, 
      包括Google联合登陆, Gmail发送邮件, AWS S3服务等. 接⼿这个项目的时候还没有Go语⾔的相关经验,
      ⼀边学习的同时⼀边做新的功能和修复Bug, 同时将⾃⼰的React技能运⽤到了项目中。`,
    },
    {
      name: 'Meme Generator',
      company: '北京华美汉盛信息技术有限公司',
  ...
  icomments: [
    ...
    '有丰富的后台开发经验，熟练掌握Linux, Apache, Mysql, PHP',
    '熟练使⽤Git / Svn 进⾏代码管理',
    '有丰富的API接⼝开发经验和多种开放平台对接经验',
    '有微信⼩程序，Electron等开发经验',
    '有很好的英⽂读写能⼒，喜欢在stackoverflow找问题的答案',
  ]
}